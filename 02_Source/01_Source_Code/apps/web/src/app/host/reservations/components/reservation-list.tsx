...
function ReservationCard({ item }: { item: Reservation }) {
  return (
    ...
    >
      ...
      <Grid className="grid-cols-[auto_16ch] items-center justify-items-end gap-2">
        <Grid className="grid-cols-[repeat(4,10ch)] items-center gap-3">
        ...
        {item.status === "cancelled" && (
          <div className="text-destructive font-medium bg-red-50 px-2 py-1 rounded shadow">
            Cancelled
          </div>
        )}
