...
ALTER TABLE "property_rules" ADD CONSTRAINT "property_rules_ruleId_rules_id_fk" FOREIGN KEY ("ruleId") REFERENCES "public"."rules"("id") ON DELETE cascade ON UPDATE no action;